...
import ListaDeFichasAceptadasPorIngeniero from "./ListaDeFichasAceptadasPorIngeniero";
...
function SesionGerenteGeneral() {
  const [mostrartabla, setMostrartabla] = useState(false);
  const [botonActivo, setBotonActivo] = useState(true);
  //////////////////////
  const tablacontext = useContext(tablaContext);
  const { altaNegocio, tablaDatosGerenteGeneral, rptaAltaNegocio } =
    tablacontext;
  ////////////////////////
  ///////////////////////////////
  ...
  const confirmarAlta = () => {
    ...
    altaNegocio(fichaTecnica[0].idFichatecnica, 1);
  };
  const denegarAlta = () => {
    console.log("hiciste click en denegarAlta");
    altaNegocio(fichaTecnica[0].idFichatecnica, 2);
  };
  return (
    <div className="container-fluid">
      ...
      <ul>
        ...
        <li>.Aceptar o denegar segun corresponda.</li>
        <li>.Hacer click en "Ver Lista de Materiales"</li>
      </ul>
      ...
      <div className="row">
        ...
        <div className=" col-12 col-xl-8">
          {mostrartabla ? (
            <div>
              {fichaTecnica &&
                (fichaTecnica[0].aprobaciongerenteFichatecnica == "1" ||
                rptaAltaNegocio === 1 ? (
                  <p className="text-uppercase text-success fw-bolder">
                    Alta de Negocio confirmado
                  </p>
                ) : fichaTecnica[0].aprobaciongerenteFichatecnica == "2" ||
                  rptaAltaNegocio === 2 ? (
...
export default SesionGerenteGeneral;
